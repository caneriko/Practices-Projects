...
namespace MyBlog.Service.Services.Concrete
{
    public class UserService : IUserService
    {
        ...
        public async Task<IdentityResult> CreateUserAsync(UserAddViewModel userAddDto)
        {
        ...
        public async Task<IdentityResult> UpdateUserAsync(UserUpdateViewModel userUpdateDto)
        {
        ...
        private async Task<Guid> UploadImageForUser(UserProfileViewModel userProfileDto)
        {
        ...
        public async Task<bool> UserProfileUpdateAsync(UserProfileViewModel userProfileDto)
        {
            var userId = _user.GetLoggedInUserId();
            var user = await GetAppUserByIdAsync(userId);
