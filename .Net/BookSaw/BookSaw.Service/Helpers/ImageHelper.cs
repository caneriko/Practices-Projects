...
namespace BookSaw.Service.Helpers
{
    public class ImageHelper : IImageHelper
    {
        ...
        private const string bookImgFolder = "book-images";
        ...
        {
            folderName ??= imageType == ImageType.User ? userImgFolder : imageType == ImageType.User ? articleImgFolder : bookImgFolder;
